...
- Do not commit `dist/`, `node_modules/`, coverage, caches, temporary files, `.DS_Store`, or other generated output. The ignored `package-lock.json` must still exist locally for validation and is generated by `npm install`.
